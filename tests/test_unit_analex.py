...
class qalsadiAnalyzerTestCase(unittest.TestCase):
    ...
    def _test_many_analysis_vocalizeds(self, words_lemmas, vocalized = False, limit=10, check_as=""):
        """
        private method
        ...
        for item in words_lemmas:
            ...
            stmnode_result = self._check_word(token, vocalized_lemma=vocalized, check_as=check_as)
            vocalizeds = stmnode_result.get_vocalizeds()
            
            # the result can be false or true,
            # if the result is expected, no error
            if collections.Counter(vocalizeds) != collections.Counter(expected_vocalizeds):
            # ~ if vocalizeds.sort() != expected_vocalizeds.sort():
                if result_flag:
                    nb_diff += 1
                    wrong_analysis.append({"token": token,
                    "output": vocalizeds,
    ...
    def test_text_cases(self, ):
        """ test text case"""
        text = u"""هل تحتاج إلى ترجمة كي تفهم خطاب الملك؟ اللغة "الكلاسيكية" (الفصحى) موجودة في كل اللغات وكذلك اللغة "الدارجة" .. الفرنسية التي ندرس في المدرسة ليست الفرنسية التي يستخدمها الناس في شوارع باريس .. وملكة بريطانيا لا تخطب بلغة شوارع لندن .. لكل مقام مقال"""
        expected_lemmas = ['هل', 'احتاج', 'إلى', 'ترجمة', 'كي', 'تف', 'خطاب', 'ملك', '؟', 'لغة', '"', 'كلاسيكي', '"(', 'فصحى', ')', 'موجود', 'في', 'كل', 'لغة', 'كذلك', 'لغة', '"', 'دارج', '"..', 'فرنسة', 'التي', 'درس', 'في', 'مدرس', 'ليست', 'فرنسة', 'التي', 'استخدم', 'ناس', 'في', 'شوارع', 'باريس', '..', 'ملك', 'بريطاني', 'لا', 'خطب', 'بلغة', 'شوارع', 'أدان', '..', 'كل', 'مقام', 'مقال']
    ...
    # ~ @unittest.skip("not yet ready ")        
    def test_analysis_vocalized_case(self, ):
        """ test case
        based on dataset"""

        
        result  = self._test_many_analysis(self.word_lemma_list, vocalized = True, limit= self.limit)
        len_wrong_cases = len(result)
        if(len_wrong_cases):
            print("Wrong cases")
            pprint.pprint(result)
    ...
    def test_analysis_vocalizations_case1(self, ):
        """ test case according to generated vocalizations
        based on dataset"""

        
        result  = self._test_many_analysis_vocalizeds(self.word_lemma_list, limit=self.limit)
        len_wrong_cases = len(result)
        if(len_wrong_cases):
            print("Wrong cases")
            pprint.pprint(result)
    ...
    def test_analysis_case1_verb(self, ):
        """ test case
        based on dataset"""

        
        result  = self._test_many_analysis(self.verb_lemma_list, limit=self.limit, check_as="verb")
        len_wrong_cases = len(result)
        if(len_wrong_cases):
            print("Wrong cases")
            pprint.pprint(result)
    ...
    # ~ @unittest.skip("not yet ready ")        
    def test_analysis_vocalized_case_verb(self, ):
        """ test case
        based on dataset"""

        
        result  = self._test_many_analysis(self.verb_lemma_list, vocalized = True, limit= self.limit, check_as="verb")
        len_wrong_cases = len(result)
        if(len_wrong_cases):
            print("Wrong cases")
            pprint.pprint(result)
    ...
    def test_analysis_vocalizations_case1_verb(self, ):
        """ test case according to generated vocalizations
        based on dataset"""

        
        result  = self._test_many_analysis_vocalizeds(self.verb_lemma_list, limit=self.limit, check_as="verb")
        len_wrong_cases = len(result)
        if(len_wrong_cases):
            print("Wrong cases")
            pprint.pprint(result)
    ...
    def test_analysis_case1_noun(self, ):
        """ test case
        based on dataset"""

        
        result  = self._test_many_analysis(self.noun_lemma_list, limit=self.limit, check_as="noun")
        len_wrong_cases = len(result)
        if(len_wrong_cases):
            print("Wrong cases")
            pprint.pprint(result)
    ...
    # ~ @unittest.skip("not yet ready ")        
    def test_analysis_vocalized_case_noun(self, ):
        """ test case
        based on dataset"""

        
        result  = self._test_many_analysis(self.noun_lemma_list, vocalized = True, limit= self.limit, check_as="noun")
        len_wrong_cases = len(result)
        if(len_wrong_cases):
            print("Wrong cases")
            pprint.pprint(result)
    ...
    def test_analysis_vocalizations_case1_noun(self, ):
        """ test case according to generated vocalizations
        based on dataset"""

        
        result  = self._test_many_analysis_vocalizeds(self.noun_lemma_list, limit=self.limit, check_as="noun")
        len_wrong_cases = len(result)
        if(len_wrong_cases):
            print("Wrong cases")
            pprint.pprint(result)
    ...
    def test_analysis_case1_stopword(self, ):
        """ test case
        based on dataset"""

        
        result  = self._test_many_analysis(self.stopword_lemma_list, limit=self.limit, check_as="stopword")
        len_wrong_cases = len(result)
        if(len_wrong_cases):
            print("Wrong cases")
            pprint.pprint(result)
    ...
    # ~ @unittest.skip("not yet ready ")        
    def test_analysis_vocalized_case_stopword(self, ):
        """ test case
        based on dataset"""

        
        result  = self._test_many_analysis(self.stopword_lemma_list, vocalized = True, limit= self.limit, check_as="stopword")
        len_wrong_cases = len(result)
        if(len_wrong_cases):
            print("Wrong cases")
            pprint.pprint(result)
    ...
    def test_analysis_vocalizations_case1_stopword(self, ):
        """ test case according to generated vocalizations
        based on dataset"""

        
        result  = self._test_many_analysis_vocalizeds(self.stopword_lemma_list, limit=self.limit, check_as="stopword")
        len_wrong_cases = len(result)
        if(len_wrong_cases):
            print("Wrong cases")
            pprint.pprint(result)
    ...
    def test_analysis_case1_unknown(self, ):
        """ test case
        based on dataset"""

        
        result  = self._test_many_analysis(self.unknown_lemma_list, limit=self.limit, check_as="unknown")
        len_wrong_cases = len(result)
        if(len_wrong_cases):
            print("Wrong cases")
            pprint.pprint(result)
    ...
    # ~ @unittest.skip("not yet ready ")        
    def test_analysis_vocalized_case_unknown(self, ):
        """ test case
        based on dataset"""

        
        result  = self._test_many_analysis(self.unknown_lemma_list, vocalized = True, limit= self.limit, check_as="unknown")
        len_wrong_cases = len(result)
        if(len_wrong_cases):
            print("Wrong cases")
            pprint.pprint(result)
    ...
    def test_analysis_vocalizations_case1_unknown(self, ):
        """ test case according to generated vocalizations
        based on dataset"""

        
        result  = self._test_many_analysis_vocalizeds(self.unknown_lemma_list, limit=self.limit, check_as="unknown")
        len_wrong_cases = len(result)
        if(len_wrong_cases):
            print("Wrong cases")
            pprint.pprint(result)
    ...
    def test_analysis_case1_pounct(self, ):
        """ test case
        based on dataset"""

        
        result  = self._test_many_analysis(self.pounct_lemma_list, limit=self.limit, check_as="pounct")
        len_wrong_cases = len(result)
        if(len_wrong_cases):
            print("Wrong cases")
            pprint.pprint(result)
    ...
    # ~ @unittest.skip("not yet ready ")        
    def test_analysis_vocalized_case_pounct(self, ):
        """ test case
        based on dataset"""

        
        result  = self._test_many_analysis(self.pounct_lemma_list, vocalized = True, limit= self.limit, check_as="pounct")
        len_wrong_cases = len(result)
        if(len_wrong_cases):
            print("Wrong cases")
            pprint.pprint(result)
    ...
    def test_analysis_vocalizations_case1_pounct(self, ):
        """ test case according to generated vocalizations
        based on dataset"""

        
        result  = self._test_many_analysis_vocalizeds(self.pounct_lemma_list, limit=self.limit, check_as="pounct")
        len_wrong_cases = len(result)
        if(len_wrong_cases):
            print("Wrong cases")
            pprint.pprint(result)
