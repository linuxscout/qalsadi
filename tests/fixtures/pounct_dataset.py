...
Lemmas_DataSet = [
{'token': 'هل', 'lemmas': [], 'wordtype': 'ambiguous', 'vocalizeds': [], 'equal': True} ,
...
{'token': 'كل', 'lemmas': [], 'wordtype': 'ambiguous', 'vocalizeds': [], 'equal': True} ,
...
{'token': '..', 'lemmas': ['..'], 'wordtype': 'pounct', 'vocalizeds': ['..'], 'equal': True} ,
{'token': 'لكل', 'lemmas': [], 'wordtype': 'ambiguous', 'vocalizeds': [], 'equal': True} ,
