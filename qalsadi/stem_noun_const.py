...
CONJ_SUFFIX_LIST_TAGS = {
    ...
    u"َةٌ": {
        'tags': (u'مؤنث', u'مرفوع', u'متحرك', u"تنوين"),
        'vocalized': (u"َةٌ", )
    },  #TEH_MARBUTA,
    u'َةٍ': {
        'tags': (u'مؤنث', u'مجرور', u'متحرك', u"تنوين"),
        'vocalized': (u'َةٍ', )
    },  #TEH_MARBUTA,
    u'َةِ': {
        'tags': (
    ...
    u"َةً": {
        'tags': (u'مؤنث', u'منصوب', u'متحرك', u"تنوين"),
        'vocalized': (u"َةً", )
    },  #TEH_MARBUTA,
    u"ية": {
        'tags': (u'مؤنث', u'مجرور', u'منسوب', u'يعرب'),
    ...
    u"ِيَّةٌ": {
        'tags': (u'مؤنث', u'مرفوع', u'متحرك', u"تنوين", u'منسوب'),
        'vocalized': (u"ِيَّةٌ", )
    },  #TEH_MARBUTA,
    u'ِيَّةٍ': {
        'tags': (u'مؤنث', u'مجرور', u'متحرك', u"تنوين", u'منسوب'),
        'vocalized': (u'ِيَّةٍ', )
    },  #TEH_MARBUTA,
    u'ِيَّةِ': {
        'tags': (
    ...
    u"ات": {
        'tags': (u'جمع مؤنث سالم', u'مجرور', u'متحرك', u'جمع', u'يعرب'),
        'vocalized': (u'َاتُ', u'َاتٌ', u'َاتٍ', u'َاتِ')
    },  #ALEF+TEH,
    u'َاتُ': {
        'tags': (u'جمع مؤنث سالم', u'مرفوع', u'متحرك', u'ينون', u'جمع'),
        'vocalized': (u'َاتُ', )
    },  #ALEF+TEH,
    u'َاتٌ': {
        'tags': (u'جمع مؤنث سالم', u'مرفوع', u'متحرك', u'تنوين', u'جمع'),
        'vocalized': (u'َاتٌ', )
    },  #ALEF+TEH,
    u'َاتٍ': {
        'tags': (u'جمع مؤنث سالم', u'متحرك', u'تنوين', u'جمع'),
        'cases': (u'مجرور', u'منصوب'),
        'vocalized': (u'َاتٍ', )
    },  #ALEF+TEH,
    u'َاتِ': {
        'tags': (u'جمع مؤنث سالم', u'متحرك', u'ينون', u'جمع'),
        'cases': (u'مجرور', u'منصوب'),
        'vocalized': (u'َاتِ', )
    },  #ALEF+TEH,
    u"ون": {
    ...
    u'َيْنِ': {
        'tags': (u'مجرور', u'منصوب', u'لايضاف', u'مثنى'),
        'vocalized': (u'َيْنِ', )
    },  #YEH+NOON,
    u"و": {
        'tags': (u'جمع مذكر سالم', u'إضافة', u'جمع'),
        'vocalized': (u'ُو', )
    },  #WAW,
    u'ُو': {
        'tags': (u'جمع مذكر سالم', u'إضافة', u'جمع'),
    ...
    u'ي': {
        'tags': (),
        'vocalized': (u'ِي', u'َيْ', u'ِيُّ', u'ِيٌّ', u'ِيَّ', u'ِيِّ',
                      u'ِيٍّ')
    },  #YEH,
    u'يا': {
        'tags': (u'منسوب', u'منصوب', u'تنوين'),
        'vocalized': (u'يا', u'ِيًّا')
    },  #YEH,
    u'ِيًّا': {
        'tags': (u'منسوب', u'منصوب', u'تنوين'),
        'vocalized': (u'يا', )
    ...
    u'ِيٍّ': {
        'tags': (u'منسوب', u'مجرور', u'تنوين'),
        'vocalized': (u'ي', )
    },  #YEH,
    u"ان": {
        'tags': (u'مثنى', u'لايضاف', u'مرفوع'),
        'vocalized': (u'َانِ', )
    },  #ALEF+NOON,
    u'َانِ': {
        'tags': (u'مثنى', u'لايضاف', u'مرفوع'),
